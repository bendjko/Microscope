...
int ImarisImageManager::ImageType()
{
	return 0;
}
...
void ImarisImageManager::WriteFile(unsigned char* buf, unsigned long long writeSize, MICROSCOPE_METADATA* metabuffer, unsigned long long metabufwriteSize, bool newImage)
{
